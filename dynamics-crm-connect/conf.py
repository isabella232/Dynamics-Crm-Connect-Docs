...
extlinks = {
    'def-doc-url':(base_def_docs_url + '%s', base_def_docs_url),
    'def-root':(base_def_docs_url + '/%s', ''),
    'def-framework-component':(base_def_docs_url + '/components/framework/%s', ''),
    'def-providers-sitecore-component':(base_def_docs_url + '/components/sitecore/%s', ''),
    'def-providers-crm-component':(base_def_docs_url + '/components/dynamics-crm/%s', ''),
    'def-whats-new':(base_def_docs_url + '/whats-new/' + version + '/index.html', ''),
    }
...
htmlhelp_basename = 'dynamics-crm-connect-docs'
...
latex_documents = [
  ('index', 'dynamics-crm-connect.tex', 'Dynamics CRM Connect 1.0 Documentation',
   'Sitecore', 'manual'),
]
